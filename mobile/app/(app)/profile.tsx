...
export default function ProfileScreen() {
  ...
  const [gender, setGender] = useState<Gender>("o" as Gender);
  ...
  useEffect(() => {
    if (state?.userProfile) {
      ...
      setAge(state.userProfile.age || 0);
      setGender(state.userProfile.gender || "o");
      ...
      >
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.inputItem, { flex: 1 }]}>
              ...
              <Dropdown
                ...
                data={[{ label: "Male", value: "m" }, { label: "Female", value: "f" }, { label: "Other", value: "o" }]}
                labelField="label"
                valueField="value"
        ...
        <View style={styles.formCard}>
          ...
          <Text style={styles.infoText}>
            This information is stored locally and encrypted.
          </Text>
        </View>
          ...
          <View style={styles.securityRow}>
            <View style={{ flex: 1 }}>
              ...
              <Text style={styles.securityDesc}>
                Requires FaceID/Fingerprint enrollment
              </Text>
            </View>
            <Switch
              value={biometrics}
